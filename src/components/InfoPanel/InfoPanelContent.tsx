    ...
    <>
      ...
      <div className="w-full mb-8">
        <div className="flex items-center justify-between">
          <h2 className="text-3xl font-bold text-slate-800 dark:text-slate-200" suppressHydrationWarning>
      ...
      <div className="w-full space-y-8">
        ...
        {diveSite.description && (
          <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl p-4 border border-slate-200/50 dark:border-slate-600/50 shadow-sm">
            <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">{diveSite.description}</p>
          </div>
        )}
        ...
        <div className="bg-gradient-to-br from-blue-50/80 to-cyan-50/60 dark:from-blue-900/20 dark:to-cyan-900/20 backdrop-blur-sm rounded-2xl p-4 border border-blue-200/50 dark:border-blue-600/50 shadow-sm">
          <h4 className="font-semibold text-slate-800 dark:text-slate-200 mb-4" suppressHydrationWarning>
            {t('characteristics')}
          </h4>
          ...
          <div className="space-y-2">
            ...
            {diveSite.rating !== 0 && (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold text-slate-700 dark:text-slate-300">({diveSite.rating}/5)</span>
                </div>
              </div>
            )}
          </div>
