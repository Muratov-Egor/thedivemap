...
const Chip = React.forwardRef<HTMLButtonElement, ChipProps>(
  (
    ...
    const variantStyles = {
      ...
      subtle: {
        selected: 'bg-blue-100 dark:bg-blue-900/50 text-tropical-blue dark:text-blue-300 border-2 border-tropical-blue dark:border-blue-400 hover:bg-blue-200 dark:hover:bg-blue-800/50',
        unselected:
